 ...
 * @Date: 2023-05-08 10:09:56
 * @LastEditors: AIkikaze wenwenziy@163.com
 * @LastEditTime: 2023-05-09 15:48:06
 * @FilePath: \Cplusplus-playground\ImageProcessing100\problems_31-40\answer_cpp\answer_33.cpp
 * @Description: 
 * 
 */
...
void lowpassFilter(Mat &I, double R) {
  // 中心化经过傅里叶变换的复数矩阵
  recenter(I);
  // 初始化低通滤波核
